...
_TEMPLATES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "final_lap_save_fuel": "Last lap. Fuel is low. Save fuel and bring it home.",
    ...
    "pt": {
        ...
        "final_lap_save_fuel": "Última volta. Combustível baixo. Economize e traga o carro pra casa.",
