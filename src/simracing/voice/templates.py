...
_TEMPLATES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "advisor_pit_approaching": "Box window in {laps} laps. Prepare to box.",
        "advisor_pit_open": "Box window open. {laps} laps to box.",
    ...
    "pt": {
        ...
        "advisor_pit_approaching": "Janela de parada em {laps} voltas. Prepare-se para o box.",
        "advisor_pit_open": "Janela de parada aberta. {laps} voltas para o box.",
