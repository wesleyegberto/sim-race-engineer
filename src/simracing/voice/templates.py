...
_TEMPLATES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "planned_pit_soon": "Planned pit stop in {laps} lap. Prepare to box.",
        "planned_pit_now": "Box this lap. On strategy.",
        "planned_pit_missed": "Missed planned pit on lap {lap}. Re-evaluating.",
        "planned_pit_rescheduled": "Planned stop rescheduled to lap {lap}. Fuel window.",
        "tyre_wont_reach": "Warning: tyres last {life_lap} laps. Planned stop at lap {plan_lap}.",
    },
    "pt": {
        ...
        "planned_pit_soon": "Pit planejado em {laps} volta. Prepare-se.",
        "planned_pit_now": "Box nesta volta. Na estratégia.",
        "planned_pit_missed": "Janela de pit perdida na volta {lap}. Reavaliando.",
        "planned_pit_rescheduled": "Parada reagendada para a volta {lap}. Janela de combustível.",
        "tyre_wont_reach": "Atenção: pneus estimados até volta {life_lap}. Pit planejado na {plan_lap}.",
    },
}
